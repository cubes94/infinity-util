 ...
 * 1. 启动{@link com.infinity.training.spring.mybatis.InfinityMybatisSpringApp#main}。
 * <p>
 * 2. 通过InfinityMybatisSpringApp上的注解{@link com.infinity.training.spring.mybatis.plugins.annotation.InfinityMapperScan},
 * 该注解上存在{@link org.springframework.context.annotation.Import}注解，通过Import注解可以将实例加入spring的IOC容器中，可用于导入第三方包。
 * 此处注解内属性为{@link com.infinity.training.spring.mybatis.plugins.annotation.InfinityMapperScannerRegistrar}。
 * <p>
 * 3. InfinityMapperScannerRegistrar执行registerBeanDefinitions方法，
 * 创建类型为{@link com.infinity.training.spring.mybatis.plugins.mapper.InfinityMapperScannerConfigurer}的Bean，
 ...
 * 创建{@link com.infinity.training.spring.mybatis.plugins.mapper.InfinityClassPathMapperScanner}类扫描器，同时自定义过滤条件，对mapper进行扫描。
 * <p>
 * 5. InfinityClassPathMapperScanner扫描器将过滤后符合条件的BeanDefinition取出，设置其beanClass为{@link com.infinity.training.spring.mybatis.plugins.mapper.InfinityMapperFactoryBean}，
